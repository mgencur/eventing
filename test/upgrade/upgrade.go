...
func (fe *DurableFeature) Setup(label string) pkgupgrade.Operation {
	return pkgupgrade.NewOperation(label+"/Setup/"+fe.SetupF.Name, func(c pkgupgrade.Context) {
		c.T.Parallel()
...
func (fe *DurableFeature) Verify(label string) pkgupgrade.Operation {
	return pkgupgrade.NewOperation(label+"/Verify/"+fe.VerifyF.Name, func(c pkgupgrade.Context) {
		c.T.Parallel()
		ctx, env := fe.Global.Environment(
			knative.WithKnativeNamespace(system.Namespace()),
			knative.WithLoggingConfig,
...
func (fe *DurableFeature) VerifyTeardown(label string) pkgupgrade.Operation {
	return pkgupgrade.NewOperation(label+"/VerifyTeardown/"+fe.VerifyF.Name, func(c pkgupgrade.Context) {
		c.T.Parallel()
		ctx, env := fe.Global.Environment(
			knative.WithKnativeNamespace(system.Namespace()),
			knative.WithLoggingConfig,
...
func (fe *DurableFeature) SetupVerifyTeardown(label string) pkgupgrade.Operation {
	return pkgupgrade.NewOperation(label+"/SetupVerifyTeardown/"+fe.SetupF.Name, func(c pkgupgrade.Context) {
		c.T.Parallel()
		ctx, env := fe.Global.Environment(
			knative.WithKnativeNamespace(system.Namespace()),
			knative.WithLoggingConfig,
